...
passthru(__DIR__ . '\7z\7z.exe a -tzip wpn-xm-scp-x86_boxed.zip wpn-xm.exe -mx9 -mmt');
...
passthru(__DIR__ . '\7z\7z.exe a -tzip wpn-xm-scp-x86_64_boxed.zip wpn-xm.exe -mx9 -mmt');
unlink(__DIR__ . '\wpn-xm.exe');
